...
function ProductDetails({cartItems, setCartItems}) {
    ...
    useEffect(()=>{
        const getProducts = async () =>{
            const response = await fetch("https://e-commerce-back-end-cay8.vercel.app/api/products/"+id, {
              method:"GET",
            //   headers :{
        ...
        <div className="row f-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
                ...
                <div className="stockCounter d-inline">
                 ...
                 <button type="button" onClick={addtToCart} disabled={product.stock == 0} id="cart_btn" className="btn btn-primary d-inline ml-4">Add to Cart</button>
